...
public class DistributionDataAdapter extends   RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private List<Distribution> orders;
    private OnClick onClick;

    public DistributionDataAdapter(List<Distribution> orders){
        this.orders = orders;
    }

    public interface OnClick{
        void onClick(int postion, Distribution order);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Distribution item = orders.get(position);
    ...
    public class OrderDataViewHolder extends SwipeToAction.ViewHolder<Distribution> {
